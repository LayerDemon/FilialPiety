...
- (void)commonInit{
    ...
    trackView_ = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height-kTrackViewHeight-1,100, kTrackViewHeight)];
...
- (void)layoutTabbar{
    ...
    trackView_.frame = CGRectMake(trackX, trackView_.frame.origin.y, 100, kTrackViewHeight);
}
...
- (void)switchingFrom:(NSInteger)fromIndex to:(NSInteger)toIndex percent:(float)percent{
    ...
    trackView_.frame = CGRectMake(trackX, trackView_.frame.origin.y, 100, CGRectGetHeight(trackView_.bounds));
}
